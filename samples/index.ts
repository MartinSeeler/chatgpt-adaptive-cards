...
import flightItinerary from "./flight";
import type { IAdaptiveCard } from "adaptivecards/lib/schema";

export { activityUpdate, flightItinerary };

export const calendarReminder: IAdaptiveCard = {
  $schema: "http://adaptivecards.io/schemas/adaptive-card.json",
  type: "AdaptiveCard",
  version: "1.0",
  speak:
    'Your  meeting about "Adaptive Card design session" is starting at 12:30pmDo you want to snooze  or do you want to send a late notification to the attendees?',
  body: [
    {
      type: "TextBlock",
...
export const flightUpdate: IAdaptiveCard = {
  $schema: "http://adaptivecards.io/schemas/adaptive-card.json",
  type: "AdaptiveCard",
  version: "1.0",
  speak:
    "Flight KL0605 to San Fransisco has been delayed.It will not leave until 10:10 AM.",
  body: [
    {
      type: "ColumnSet",
      columns: [
...
export const foodOrder: IAdaptiveCard = {
  $schema: "http://adaptivecards.io/schemas/adaptive-card.json",
  type: "AdaptiveCard",
  version: "1.4",
  body: [
...
export const weatherCompact = {
  ...
  version: "1.0",
  speak:
    "The forecast for Seattle January 20 is mostly clear with a High of 51 degrees and Low of 40 degrees",
  body: [
    {
      type: "TextBlock",
      text: "Seattle, WA",
...
export const weatherLarge = {
  ...
  version: "1.0",
  speak:
    "Weather forecast for Monday is high of 62 and low of 42 degrees with a 20% chance of rainWinds will be 5 mph from the northeast",
  backgroundImage:
